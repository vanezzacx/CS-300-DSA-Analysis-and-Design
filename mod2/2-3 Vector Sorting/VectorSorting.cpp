 ...
 */
int partition(vector<Bid>& bids, int begin, int end) {//set low and high equal to begin and end
 ...
 */
void quickSort(vector<Bid>& bids, int begin, int end) {    //set mid equal to 0
...
void selectionSort(vector<Bid>& bids) {
    int size = bids.size(); //define min as int (index of the current minimum bid)
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 3: {
        //initializa clock time
            ticks = clock();

            //Selection sort on all bids
            selectionSort(bids);

            //Output selection sorting results
            ticks = clock() - ticks;
        ...
        //initialize clock time
            ...
            //Quick sort on all bids
            quickSort(bids, 0, bids.size() - 1);

            //Output quick sorting results
            ticks = clock() - ticks;
            cout << bids.size() << " bids sorted" << endl;
            cout << "time: " << ticks << " clock ticks" << endl;
            cout << "time: " << (double)ticks / CLOCKS_PER_SEC << " seconds" << endl;
